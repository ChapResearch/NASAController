...
public class ContributorF extends Activity {
    public Activity activity;
    private String team_number;
    private boolean color;
    private boolean status;
    private boolean changed = false; // when recieved first time-set false | second time - set true;
    private final String F_recieve = "b5c1d1ae-eb68-42f2-bc5f-278902252ca9";
    private final String F_transmit = "1a17ae70-1d3f-4193-81c1-99a40cd219cf";
    private TextView team_num;
    private ImageView team_color;
    private ImageView data_status;

    public ContributorF(String team_number, boolean color, boolean status, Activity activity, TextView team_num, ImageView c, ImageView s) {
